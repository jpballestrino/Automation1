...
class bolsa_peinado(unittest.TestCase):
    @classmethod
    def setUpClass(inst):
    ...
    def test_bolsa(self):
        ...
        popup.click()
        CTA_detalle = self.driver.find_element(By.XPATH, value='//*[@id="service-45"]/div/div[3]/a')
        CTA_detalle.click()
        ...
        if elemento_en_bolsa.text == "The Hippie":
            actualizar_state("GLITZI", status_test="passed", case_id=62, run_id=active_id)
        else:
            actualizar_state("GLITZI", status_test="failed", case_id=62, run_id=active_id)
        self.assertEqual(elemento_en_bolsa.text, "The Hippie")
