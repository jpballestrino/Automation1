...
class Pagar_cita_tarjeta_debito(unittest.TestCase):
    ...
    # def pago_tarjeta(self):
        ...
        self.search_field.send_keys(data.nro_tarjeta_debito)
        ...
        if verificar.text=="¿Quieres personalizar tu cita?":
            actualizar_state("GLITZI",status_test="passed",  case_id=131, run_id=active_id)
        else:
            actualizar_state("GLITZI",status_test="failed",  case_id=131, run_id=active_id)
