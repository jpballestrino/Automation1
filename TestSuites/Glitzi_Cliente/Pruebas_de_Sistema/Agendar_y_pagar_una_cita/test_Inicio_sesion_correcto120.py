...
class Login(unittest.TestCase):
    ...
    def test_login(self):
        ...
        verificar=self.driver.find_element(By.XPATH,value='/html/body/div[1]/div/div/div[2]/h1')
        time.sleep(1)
        if verificar.text=="PERFIL DE USUARIO":
            actualizar_state("GLITZI",status_test="passed",  case_id=120, run_id=active_id)
        else:
            actualizar_state("GLITZI",status_test="failed",  case_id=120, run_id=active_id)
        self.assertEqual(verificar.text, "PERFIL DE USUARIO")
