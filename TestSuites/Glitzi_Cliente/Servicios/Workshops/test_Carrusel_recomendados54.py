...
class carusel_workshops_recom(unittest.TestCase):
    @classmethod
    def setUpClass(inst):
    ...
    def test_carousel(self):
        ...
        CTA_detalle.click()
        CTA_agregar = self.driver.find_element(By.XPATH, value='//*[@id="button-add-1301"]/div[3]/button')
        CTA_agregar.click()
        CTA_bolsa = self.driver.find_element(By.XPATH,
                                             value='//*[@id="sectionsNav"]/div/div[2]/div[2]/div/div/div[2]/ul[2]/li[3]/a')
        CTA_bolsa.click()
        elemento_en_bolsa = self.driver.find_element(By.XPATH, value='//*[@id="ml-service-1301"]/div[2]/div/div[1]/span')

        if elemento_en_bolsa.text == "Auto-peinado":
            actualizar_state("GLITZI", status_test="passed", case_id=54, run_id=active_id)
        else:
            actualizar_state("GLITZI", status_test="failed", case_id=54, run_id=active_id)
        self.assertEqual(elemento_en_bolsa.text, "Auto-peinado")
