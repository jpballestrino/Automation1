...
class serv_recom_y_serv(unittest.TestCase):
    ...
    def test_bolsa(self):
        ...
        CTA_agregar_recom = self.driver.find_element(By.XPATH, value='//*[@id="button-add-1302"]/div[3]/button')
        ...
        elemento_en_bolsa_1 = self.driver.find_element(By.XPATH,
                                                       value='//*[@id="ml-service-1301"]/div[2]/div/div[1]/span')
        elemento_en_bolsa_2 = self.driver.find_element(By.XPATH,
                                                       value='//*[@id="ml-service-1304"]/div[2]/div/div[1]/span')
        if elemento_en_bolsa_1.text == "Auto-peinado" and elemento_en_bolsa_2.text == 'Auto-masaje':
            a = 1
            actualizar_state("GLITZI", status_test="passed", case_id=84, run_id=active_id)
        else:
            a = 0
            actualizar_state("GLITZI", status_test="failed", case_id=84, run_id=active_id)
