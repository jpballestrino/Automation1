...
class ver_detalles_belleza(unittest.TestCase):
    @classmethod
    def setUpClass(inst):
    ...
    def test_detalles(self):
        ...
        popup.click()
        CTA_detalle = self.driver.find_element(By.XPATH, value='//*[@id="service-594"]/div/div[3]/a')
        CTA_detalle.click()
        ...
        if description.text == "DESCRIPCIÓN":
            actualizar_state("GLITZI", status_test="passed", case_id=46, run_id=active_id)
        else:
            actualizar_state("GLITZI", status_test="failed", case_id=46, run_id=active_id)
