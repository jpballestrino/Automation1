...
class carusel_belleza_recom(unittest.TestCase):
    @classmethod
    def setUpClass(inst):
    ...
    def test_carousel(self):
        ...
        popup.click()
        CTA_detalle = self.driver.find_element(By.XPATH, value='//*[@id="service-1368"]/div/div[3]/a')
        CTA_detalle.click()
        CTA_agregar = self.driver.find_element(By.XPATH, value='//*[@id="button-add-78"]/div[3]/button')
        CTA_agregar.click()
        ...
        if elemento_en_bolsa.text == "Facial Profundo":
            actualizar_state("GLITZI", status_test="passed", case_id=49, run_id=active_id)
        else:
            actualizar_state("GLITZI", status_test="failed", case_id=49, run_id=active_id)
        self.assertEqual(elemento_en_bolsa.text, "Facial Profundo")
