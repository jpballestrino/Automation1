...
class serv_recom_y_serv(unittest.TestCase):
    ...
    def test_bolsa(self):
        ...
        popup.click()
        CTA_detalle = self.driver.find_element(By.XPATH, value='//*[@id="service-1346"]/div/div[3]/a')
        CTA_detalle.click()
        ...
        CTA_agregar_recom = self.driver.find_element(By.XPATH, value='//*[@id="button-add-80"]/div[3]/button')
        ...
        elemento_en_bolsa_1 = self.driver.find_element(By.XPATH,
                                                       value='//*[@id="ml-service-80"]/div[2]/div/div[1]/span')
        elemento_en_bolsa_2 = self.driver.find_element(By.XPATH,
                                                       value='//*[@id="ml-service-1346"]/div[2]/div/div[1]/span')
        if elemento_en_bolsa_1.text == "Masaje Descontracturante" and elemento_en_bolsa_2.text == 'Paquete corte y barbería':
            a = 1
            actualizar_state("GLITZI", status_test="passed", case_id=83, run_id=active_id)
        else:
            a = 0
            actualizar_state("GLITZI", status_test="failed", case_id=83, run_id=active_id)
