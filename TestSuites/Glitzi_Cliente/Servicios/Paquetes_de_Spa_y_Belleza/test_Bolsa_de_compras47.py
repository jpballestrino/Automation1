...
class bolsa_belleza(unittest.TestCase):
    @classmethod
    def setUpClass(inst):
    ...
    def test_bolsa(self):
        ...
        popup.click()
        CTA_detalle = self.driver.find_element(By.XPATH, value='//*[@id="service-603"]/div/div[3]/a')
        CTA_detalle.click()
        ...
        CTA_seguir.click()
        elemento_en_bolsa = self.driver.find_element(By.XPATH, value='//*[@id="ml-service-603"]/div[2]/div/div[1]/span')

        if elemento_en_bolsa.text == "Mani & Pedi Spa":
            actualizar_state("GLITZI", status_test="passed", case_id=47, run_id=active_id)
        else:
            actualizar_state("GLITZI", status_test="failed", case_id=47, run_id=active_id)
        self.assertEqual(elemento_en_bolsa.text, "Mani & Pedi Spa")
