...
class serv_recom_y_serv(unittest.TestCase):
    ...
    def test_bolsa(self):
        ...
        popup.click()
        CTA_detalle = self.driver.find_element(By.XPATH, value='//*[@id="service-69"]/div/div[3]/a')
        CTA_detalle.click()
        ...
        elemento_en_bolsa_1 = self.driver.find_element(By.XPATH,
                                                       value='//*[@id="ml-service-1421"]/div[2]/div/div[1]/span')
        ...
        if elemento_en_bolsa_1.text == "Pedi para deportistas" and elemento_en_bolsa_2.text == 'Reflexología Podal':
            a = 1
            actualizar_state("GLITZI", status_test="passed", case_id=80, run_id=active_id)
        else:
            a = 0
            actualizar_state("GLITZI", status_test="failed", case_id=80, run_id=active_id)
